...
Agentic AI Exam Study Guide

Contents

Agent Architecture and Design:   2
Exam Weight 15%
...
Cognition, Planning, and Memory:  6
Exam Weight 10%

Knowledge Integration, and Data Handling:   7
Exam Weight 10%

NVIDIA Platform Implementation:  8
Exam Weight 7%

Run, Monitor, and Maintain:  9
Exam Weight 7%

Safety, Ethics, and Compliance:  10
Exam Weight 5%

Human-AI Interaction and Oversight:  11
Exam Weight 5%

NVIDIA-Certified Professional:  
Agentic AI Exam Study Guide

NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 1

This study guide provides an overview of each topic covered on the NVIDIA-Certified Professional: Agentic AI certification exam, 
recommended training, and suggested reading to prepare for the exam.

Job Description

The agentic AI professional is an intermediate practitioner adept at designing, evaluating, and deploying autonomous AI systems. 
Responsibilities include constructing resilient, secure, and trustworthy agentic solutions such as customer/employee assistants, 
automated meeting companions, and productivity tools (e.g., content generation, analytics). The candidate must master agentic 
AI architecture fundamentals—including reactive, deliberative, and hybrid systems—and excel in goal-oriented reasoning, chain-
of-thought prompt engineering, and tool orchestration with robust error handling.

Expertise includes memory management (short- and long-term context), evaluation frameworks, deployment of containerized 
workflows, monitoring/logging, ethical safeguards (e.g., bias detection, privacy preservation, guardrails), troubleshooting 
hallucinations, tracing failures, and managing stateful orchestration for complex, multi-turn tasks. They combine generative AI 
and reasoning systems knowledge with MLOps workflow deployment and GPU-optimized operations to ensure scalable, ethical 
implementation.
...
NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 2

Certification Topics and References

Agent Architecture and Design:  Exam Weight 15%

Foundational structuring and design of agentic AI systems, focusing on how agents interact, reason, and communicate within 
their environments. 
...
Suggested Readings
 ...
 NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 3
...
Suggested Readings
 ...
 NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 4
...
NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 5
...
Suggested Readings
 ...
 NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 6

Cognition, Planning, and Memory: Exam Weight 10%

Core cognitive processes underlying intelligent agent behavior, including reasoning strategies, decision-making,  
...
NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 7
...
NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 8
...
Suggested Readings
 ...
 NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 9
...
NVIDIA-Certified Professional | Agentic AI Exam Study Guide | 10

Safety, Ethics, and Compliance: Exam Weight 5%

Principles and practices that ensure agentic AI systems operate responsibly, uphold ethical standards, and comply with legal 
...
© 2025 NVIDIA Corporation and affiliates. All rights reserved. NVIDIA, the NVIDIA logo, DGX, NeMo, NIM, Nsight, 
TensorRT, and Triton are trademarks and/or registered trademarks of NVIDIA Corporation and affiliates in the U.S. 
and other countries. Other company and product names may be trademarks of the respective owners with which 
they are associated. 4230000. SEP25
